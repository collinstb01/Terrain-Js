...
import { MyTerraDappClient } from './contract/clients/MyTerraDappClient'
...
const App = () => {
  ...
  const contractClient = useMemo(() => {
    ...
    return new MyTerraDappClient(lcd, connectedWallet, contractAddress('my_terra_dapp', connectedWallet));
  }, [lcd, connectedWallet]);
